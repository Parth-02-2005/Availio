...
import { Calendar, ArrowRight, Github, Mail, Lock, AlertCircle, ChevronLeft } from 'lucide-react';
...
const SigninPage = () => {
  ...
  const onSubmit = async (data: SigninFormData) => {
    // This will connect to your Week 1 Backend Auth API
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-white font-sans antialiased">
      {/* --- Left Side: Welcome Back Branding --- */}
      <div className="hidden lg:flex flex-col justify-between p-12 bg-slate-50 border-r border-slate-100 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl font-black text-slate-900 leading-tight mb-6">
            Welcome back to <br />
            <span className="text-indigo-600">the dashboard.</span>
          </h1>
          <p className="text-lg text-slate-500 font-medium max-w-md">
            Sign in to manage your events, track registrations, and sync your calendar.
          </p>
        </div>
      ...
      <div className="relative flex flex-col justify-center items-center p-8 lg:p-24">
        ...
        <div className="w-full max-w-md">
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-500 font-medium">Continue your journey with Slot.</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <a href="#" className="text-[10px] font-black uppercase text-indigo-600 hover:underline tracking-widest">Forgot Password?</a>
              </div>
              <div className="relative group">
