...
import { Calendar, Github, Twitter, Linkedin, Mail, ArrowUpRight, Database, Cloud } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-16 lg:gap-x-12 mb-24">
          ...
          <div className="lg:col-span-4 flex flex-col items-start text-left">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-2xl font-black tracking-tighter text-slate-900 uppercase">Slot</span>
            </div>
        ...
        <div className="pt-12 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-wrap justify-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Supabase PostgreSQL</span>
            </div>
            <div className="flex items-center gap-2">
              <Cloud size={14} className="text-indigo-600" />
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Render Infrastructure</span>
            </div>
          </div>

          <div className="flex flex-col items-center md:items-end gap-2">
            <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.4em]">
              © {currentYear} SLOT PLATFORM • MERN + PRISMA
            </p>
